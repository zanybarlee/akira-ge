...
class MetabrainGroq_ChatModels implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'Aramco Metabrain Groq LLM'
        this.name = 'metabraingroqChat'
        this.version = 4.0
        this.type = 'MetabrainGroqChat'
        this.icon = 'aramco.svg'
        this.category = 'Chat Models'
        this.description = 'Wrapper around Aramco MetaBrain Groq LLM'
...
module.exports = { nodeClass: MetabrainGroq_ChatModels }
