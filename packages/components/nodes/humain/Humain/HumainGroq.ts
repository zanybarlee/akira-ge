...
class HumainGroq_ChatModels implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'Humain Groq LLM'
        this.name = 'HumaingroqChat'
        this.version = 4.0
        this.type = 'HumainGroqChat'
        this.icon = 'humain.png'
        this.category = 'Chat Models'
        this.description = 'Wrapper around Humain Groq LLM'
...
module.exports = { nodeClass: HumainGroq_ChatModels }
